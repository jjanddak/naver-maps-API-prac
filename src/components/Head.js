    ...
    <div className="head">
      ...
      <div className="combobox">
        <select>
          ...
          <option value="system2">업무시스템2</option>
          <option value="system3">업무시스템3</option>
        </select>
        <div>▼</div>
      </div>
